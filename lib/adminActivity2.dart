  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: new Container(
        ...
        child: visitorslist.length==0?Text("No Data Available"):new ListView.builder(
            ...
            itemBuilder:(_,index)
            {
              ...
              return setui(visitorslist[index].getFirst_Name(), 'no' ,visitorslist[index].getMobile_NO(),visitorslist[index].getFeverStatus(),visitorslist[index].getVisited_Status_Update(),visitorslist[index].getMDate(),visitorslist[index].MTime,visitorslist[index].getWhomToMeet_Name(),visitorslist[index].getReason(),visitorslist[index].getRescheduledTime() );
            }
        ),
      ),
    );
